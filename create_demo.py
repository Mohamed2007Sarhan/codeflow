"""
Demonstration script for the enhanced Code Analysis and Debugging Visualizer
This script creates a sample Python file with various features to demonstrate the debugger
"""
...
with open("demo_debug_sample.py", "w") as f:
    f.write(sample_code)

print("Demo script created: demo_debug_sample.py")
print("Features included in this sample:")
print("1. Variable assignments")
print("2. Function definitions with recursion")
print("3. Class definitions with methods")
print("4. Conditional statements (if/elif/else)")
print("5. Loop constructs (for loop)")
print("6. Error conditions (division by zero, undefined variable)")
print("7. Exception handling")
print("\nTo test the enhanced debugger:")
print("1. Open this file in the Code Analysis and Debugging Visualizer")
print("2. Run the analysis")
print("3. Step through the execution")
print("4. Observe the color-coded feedback:")
print("   - Green lines: Successfully executed")
print("   - Red lines: Errors detected")
print("   - Blue line: Currently executing")
print("5. Check the timeline for status indicators (✓, ✗, ○)")